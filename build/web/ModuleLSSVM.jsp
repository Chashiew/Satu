...
<%
    ...
    int nrows1;
    if (snDFInstancesLSSVM!="") {
        nrows1=(int)Double.parseDouble(snDFInstancesLSSVM); 
    } else {
        nrows1=1;
        snDFInstancesLSSVM = "0";
    }
    int ncols1;
    if (snDFAttributesLSSVM!="") {
        ncols1=(int)Double.parseDouble(snDFAttributesLSSVM); 
    } else { 
        ncols1=1; 
        snDFAttributesLSSVM = "0";
    }
    ...
    int nrows2;
    if (snTDFInstancesLSSVM!="") {
        nrows2=(int)Double.parseDouble(snTDFInstancesLSSVM); 
    } else { 
        nrows2=1; 
        snTDFInstancesLSSVM = "0";
    }
    int ncols2;
    if (snTDFAttributesLSSVM!="") {
        ncols2=(int)Double.parseDouble(snTDFAttributesLSSVM); 
    } else { 
        ncols2=1; 
        snTDFAttributesLSSVM = "0";
    }
    ...
    int nrows3;
    if (snLDFInstancesLSSVM!="") {
        nrows3=(int)Double.parseDouble(snLDFInstancesLSSVM); 
    } else { 
        nrows3=1; 
        snLDFInstancesLSSVM = "0";
    }
    int ncols3;
    if (snLDFAttributesLSSVM!="") {
        ncols3=(int)Double.parseDouble(snLDFAttributesLSSVM); 
    } else { 
        ncols3=1;
        snLDFAttributesLSSVM = "0";
    }
    ...
    int nrows4;
    if (snPDFInstancesLSSVM!="") {
        nrows4=(int)Double.parseDouble(snPDFInstancesLSSVM); 
    } else { 
        nrows4=1;
        snPDFInstancesLSSVM = "0";
    }
    int ncols4;
    if (snPDFAttributesLSSVM!="") {
        ncols4=(int)Double.parseDouble(snPDFAttributesLSSVM); 
    } else { 
        ncols4=1;
        snPDFAttributesLSSVM = "0";
    }
                            ...
                            <div class="panel-body">
                                <div class="container boundary">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4"><h4><%=sBaseFileNameLSSVM%></h4></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <% } %>
                        ...
                        <table>
                            <tr>
                                ...
                                <i><font color="black" face="Palatino Linotype, Book Antiqua, Palatino, serif" size="3" style="float:right">Base output file name:&nbsp;&nbsp;<%=sBaseFileNameLSSVM%>&nbsp;&nbsp;&nbsp;&nbsp;</font></i><%--><--%>
                            </tr>
                        </table> 
                                            ...
                                            <div> 
                                                <table>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <% } else { %>
                                                            <td align="right">Percent Accuracy of Prediction Data</td>
                                                        <% } %>
                                                        <td align="center">=</td> 
                                                ...
                                                <div> 
                                                    <table>
                                                        <tr>
                                                            ...
                                                            <% } else {%>
                                                                <td align="center">Percent Accuracy Prediction</td>
                                                            <% } %>
                                                        </tr>
                                                    ...
                                                    <table> 
                                                        <tr>
                                                            ...
                                                            <% } else { %>
                                                                <td align="center">Mean Percent Accuracy Prediction</td> 
                                                            <% } %>
                                                        </tr> 
                                                        <tr>
                    ...
                    <% } %>
                            ...
                            <% if (sPageControl.equals("3")) { %>
                                ...
                                <center>
                                    ...
                                    <% if (GraphNo == 31) { %>
                                        <% if (PRadioLSSVM.equals("PRadio1LSSVM")) { %>
                                            <h4><b><font color="black" face="Palatino Linotype, Book Antiqua, Palatino, serif">Test data of fold #1:</font></b></h4>     
                                        <% } else { %> 
