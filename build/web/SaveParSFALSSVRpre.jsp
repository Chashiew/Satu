<%
    ...
    content = content + "SFA-LSSVR Prediction Data:\n";
    ...
    content = content + "29\tNo. of Attributes\tsdAttributes\t" + sdAttributes+"\t-\n";
    content = content + "30\tNo. of Instances\tsdInstances\t" + sdInstances+"\t-\n";     
    content = content + "31\tSecond Data File\tsPFileData\t" + sPFileData+"\t-\n";
    content = content + "32\tNo. of Attributes\tsdPAttributes\t" + sdPAttributes+"\t-\n";
    content = content + "33\tNo. of Instances\tsdPInstances\t" + sdPInstances+"\t-\n";
    
    response.setContentType("text/plain");
    response.setHeader("Content-Disposition", "attachment; filename=Data_SFA_LSSVR_Prediction.txt"); // Force "Save As" dialogue.
