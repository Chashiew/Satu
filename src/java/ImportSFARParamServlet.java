 ...
 */
@MultipartConfig
public class ImportSFARParamServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("SFALSSVR.jsp" + params); // to return to SFALSSVM.jsp page with imported params
